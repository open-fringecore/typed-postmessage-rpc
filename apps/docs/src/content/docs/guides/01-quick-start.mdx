...
<Code code={basicClientSource} lang="typescript" title="index.mts" />

## Invoke `hello(name: string)`

<Code code={basicInvokeSource} lang="typescript" title="index.mts" />

## Done ✅

This was an example using workers, but feel free to explore [iFrames](/contexts/01-iframes/),
[windows](/contexts/04-windows/) or [shared workers](/contexts/03-shared-workers/) next.